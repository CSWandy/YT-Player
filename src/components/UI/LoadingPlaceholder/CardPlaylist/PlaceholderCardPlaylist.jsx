...
const PlaceholderCardPlaylist = ({index, layout}) => {
  return (
    <div className={`spinner`} >
        <section className={'horizontal_thumbnail'} >
            <div className={'spinner_rotation_'+index+' horizontal_thumbnail_head'}>
                <img className='horizontal_thumbnail_head_image_spinner spinner_rotation' src={spinnerIco} alt={layout+'spinner'} />
            </div>
...
export default PlaceholderCardPlaylist